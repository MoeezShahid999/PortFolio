  ...
  return (
    <div className={isDark ? "experience-card-dark":"experience-card"}>
      <div style={{background: rgb(colorArrays) }} className="experience-banner">
        ...
        <div className="experience-roundedimg"  ref = {imgRef}><div className = 'logoText'>{cardInfo.companylogo}</div></div>
        {/* <img ref = {imgRef} className = 'hiddenimg'  onLoad={() => getColorArrays()}/> */}
